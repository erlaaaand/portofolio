...
import { ProjectEntity, ProfileEntity, SkillEntity, ExperienceEntity } from '@/src/backend/module/portfolio/domains/entities';
...
export const AppDataSource = new DataSource({
  ...
  entities: [StoredFileEntity, UserEntity, ProjectEntity, ProfileEntity, SkillEntity, ExperienceEntity],
